...
if(WdjaCart!=null && WdjaCart!=""){
    ...
    if(table){
        ...
        for(var i in productlist){
            ...
            insertTd.innerHTML = '<td><input style="text-align: center;" type="number" min="1" max="1000" step="1" id="num_'+parseInt(productlist[i].id)+'" name="num_'+parseInt(productlist[i].id)+'" value="'+parseInt(productlist[i].num)+'" size="3" class="text" onchange="updateCart(this.id, this.value)" /></td>';
